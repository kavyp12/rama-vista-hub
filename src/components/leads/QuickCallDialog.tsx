        ...
        <DialogHeader>
          <div className="flex justify-between items-start">
            ...
            <Badge variant="outline" className="text-xs bg-slate-50">
              <Phone className="h-3 w-3 mr-1" /> Called {callCount}x
            </Badge>
          </div>
        </DialogHeader>
          ...
          {!callInitiated ? (
            ...
            <div className="space-y-4">
              <div className="text-xs bg-blue-50 text-blue-700 p-2 rounded-md border border-blue-200">
                <strong>Note:</strong> MCUBE automatically tracks call duration and recordings. Log the outcome and any notes below.
              </div>
                  ...
                  {callOutcomes.map((outcome) => {
                    ...
                    return (
                      <Button
                        ...
                        type="button"
                        variant="outline"
                        className={`justify-start gap-2 h-auto py-3 ${callOutcome === outcome.value
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  placeholder="Add specific conversation notes here..."
                  value={notes}
